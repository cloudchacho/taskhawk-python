...
def _send_email(to: str, subject: str, from_email: str=None, headers: dict=None, metadata: dict=None) -> None:
    # inner fn to help w mocking
    pass


@taskhawk.task
def send_email(to: str, subject: str, from_email: str=None, headers: dict=None, metadata: dict=None) -> None:
