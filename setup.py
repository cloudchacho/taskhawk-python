...
tests_require = [
    ...
    'moto<5',
    'mypy',
    'opentelemetry-sdk>=1.19; python_version >= "3.8"',
    'opentelemetry-sdk<=1.12; python_version < "3.8"',
    'pytest',
    'pytest-cov',
    'pytest-env',
]
...
setup(
    ...
    extras_require={
        ...
        'dev': [
            ...
            'build==0.10.0; python_version >= "3.7" and python_version < "3.8"',
            'pip-tools',
            'wheel',
            'boto3-stubs[sns,sqs]',
            'types-dataclasses',
        ...
        'opentelemetry': [
            'opentelemetry-api>=1.19; python_version >= "3.8"',
            'opentelemetry-api<=1.12; python_version < "3.8"',
        ],
    },
